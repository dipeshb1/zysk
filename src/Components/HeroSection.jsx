...
function NewFeatureBanner() {
    return (
        <div className="pt-10 px-4 flex flex-col items-center mt-5 md:px-32">
            <Badge><span className="bg-white border border-badgeBorder rounded-full px-3 py-1 mr-2">New feature</span> Check out the team dashboard <span className='cursor-pointer'>→</span></Badge>
